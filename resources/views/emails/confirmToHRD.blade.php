                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Hi HR! We already have a new applicant to we
                                                            check.</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        {{$candidate->nama_lengkap}}, have applied for our available
                                                        position in Boxity Central Indonesia, <br> You can see the
                                                        detailed profile of {{$candidate->nama_lengkap}} at our system
                                                        <br><br>
                                                        Please select and inform the candidate to find out the status of
                                                        their application. Your news can mean a lot and really help many
                                                        people in need. Thank you. ^_^
                                                        <br>
                                                    </p>
                                                </div>
                                            </div>
