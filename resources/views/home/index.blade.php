@extends('welcome')
@section('title', 'Home')
@section('page_description', 'Providing ERP with cloud-based web and mobile applications and distributing them on a SaaS
    basis for MSME needs.')
@section('page_keywords',
    'sistem erp terbaik, erp terbaik, erp indonesia, erp di indonesia, solusi erp, software erp
            ...
            <div class="row">
                <div class="col">
                    <div class="content-9-img video-preview wow fadeInUp">
                        ...
                        <!-- Preview Image -->
                        <img class="img-fluid" src="{!! asset('images/boxity/saas-banner-img-copy.png') !!}" alt="video-preview">
                ...
                <div class="col text-center">
                    <div class="owl-carousel brands-carousel">
                        ...
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-1.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>
                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-2.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-3.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-4.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-5.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-6.png') !!}" alt="partner-boxity-central-indonesia">
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-7.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-8.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-9.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>

                        <!-- BRAND LOGO IMAGE -->
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-10.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-11.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-12.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>
                        <div class="partner-logo-logo mx-2">
                            <img class="img-fluid" src="{!! asset('images/boxity/partner-logo-13.png') !!}" alt="partner-boxity-central-indonesia" />
                        </div>
                    ...
                    <div class="col">
                        <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-lg">With the chat feature, users can interact with each other in real-time,
                                    allowing for instant responses to questions and inquiries. This can enhance the user
                    ...
                    <div class="col">
                        <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-lg">The issue ticket feature allows users to report and track issues in a
                                    structured way. This can help identify trends and patterns in issues, making it easier
                                    to resolve them quickly and prevent similar issues from occurring in the future.
                                </p>
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="txt-block right-column wow fadeInLeft">
                        ...
                        <ul class="simple-list">
                            ...
                            <li class="list-item">
                                <p class="p-lg">
                                    <b>{{ __('optimizing_business') }}</b>{{ __('dsc_optimizing_business') }}
                                </p>
                            </li>

                            <li class="list-item">
                                <p class="p-lg">
                                    <b>{{ __('reducing_operational') }}</b>{{ __('dsc_reducing_operational') }}</p>
                            </li>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-7 col-lg-7">
                        <div class="cta-11-txt">
                            ...
                            <!-- Button -->
                            <a href="/contact"
                                class="btn btn-stateblue tra-stateblue-hover">{{ __('contact_sales') }}</a>
