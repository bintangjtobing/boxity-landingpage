...
@section('icon',
'https://res.cloudinary.com/boxity-id/image/upload/v1656495474/asset/logo-products/aquila_logo_lvv4ho.png')
...
boxity, aquila payroll
management, aquila boxity, payroll management system')
@section('tag_cover',
'https://res.cloudinary.com/boxity-id/image/upload/v1656579852/asset/logo-products/tag-cover/tag_cover-aquila_isflfp.png')
@section('content')
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-6 order-last order-md-2">
                <div class="hero-boxity-img pc-30 wow fadeInRight">
                    <img class="img-fluid" src="{!!asset('product/aquila/logo-mockup/phone-mockup.png')!!}"
                        alt="hero-image">
                </div>
            </div>
            ...
            <div class="col-md-7 col-lg-6 order-first order-md-2">
                <div class="hero-boxity-txt white-color wow fadeInLeft">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Manage online shop data optimally and real-time</h2>
                ...
                <div class="col">
                    <div class="pricing-2-table bg-white mb-40 wow fadeInUp">
                        ...
                        <div class="pricing-plan">
                            ...
                            <p>for maintenance start from</p>
                            <sup class="dark-color">IDR</sup>
                            <span class="dark-color">2,7jt</span>
                            <sup class="validity dark-color"> / month</sup>
                            <p>*exclude license price</p>
                            <a href="/schedule-demo" target="_blank"
