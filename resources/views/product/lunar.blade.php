...
@section('tag_cover',
'https://res.cloudinary.com/boxity-id/image/upload/v1656579852/asset/logo-products/tag-cover/tag_cover-lunar_qvlorm.png')
@section('content')
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-6 order-last order-md-2">
                <div class="hero-boxity-img pc-30 wow fadeInRight">
                    <img class="img-fluid" src="{!!asset('product/lunar/logo-mockup/desktop-phone.png')!!}"
                        alt="lyra-by-boxity">
                </div>
            </div>
            ...
            <div class="col-md-7 col-lg-6 order-first order-md-2">
                <div class="hero-boxity-txt white-color wow fadeInLeft">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Selling <b>online</b>, selling <b>offline easily and anywhere</b> with Lunar by
                        Boxity.</b></h2>
                    ...
                    <div class="btns-group mb-20">
                        ...
                        <a href="#" class="video-popup2 btn btn-md btn-transparent ico-20 ico-left">
                            <span class="flaticon-play"></span> See Lunar in Action
                        </a>
                    </div>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Offline & Online Access</h5>

                            <!-- Text -->
                            <p class="p-lg">No worries on internet access limitless.
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Order Management</h5>

                            <!-- Text -->
                            <p class="p-lg">Manage data order with order management
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Inventory Item Report Stock</h5>

                            <!-- Text -->
                            <p class="p-lg">Manage store inventory item with report comprehensively
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Integrated Seamlessly</h5>

                            <!-- Text -->
                            <p class="p-lg"> Integrate with various payment and dashboard on ERP
                            </p>
