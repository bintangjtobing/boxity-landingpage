        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-6 order-first order-md-2">
                <div class="hero-boxity-txt white-color wow fadeInLeft">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Manage warehouse management optimally, real-time and can be accessed anywhere</h2>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Integration with many</h5>

                            <!-- Text -->
                            <p class="p-lg">Integration into many warehouses, many companies
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Real-time visibility on inventory and stock</h5>

                            <!-- Text -->
                            <p class="p-lg">Meet data needs for real-time visibility on inventory and stock tracking
                                positions
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Manage in documents</h5>

                            <!-- Text -->
                            <p class="p-lg">Manage warehousing operations in documents
                            </p>
                                        ...
                                        <div class="col">
                                            <div class="pricing-2-table bg-white mb-40 wow fadeInUp">
                                                ...
                                                <div class="pricing-plan highlight">
                                                    ...
                                                    <p>for maintenance start from</p>
                                                    <sup class="dark-color">IDR</sup>
                                                    <span class="dark-color">2,3jt</span>
                                                    <sup class="validity dark-color"> / month</sup>
                                                    <p>*exclude license price</p>
