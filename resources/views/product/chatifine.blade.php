@extends('welcome')
@section('title', 'Chatify by Boxity')
@section('page_description', 'Communication now more convenient, safe with the Chatifine by Boxity chat application.')
@section('page_keywords', 'boxity, boxityerp, realizeboxity, boxity central indonesia, chatifine by boxity, chatifine secure chat app, chatifine chat, chatifine business chat app, chatifine boxity, business chat app')
@section('content')
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-6 order-first order-md-2">
                <div class="hero-boxity-txt white-color wow fadeInLeft">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Communication is more convenient, safe with the Chatifine by Boxity chat
                        application</h2>
                    ...
                    <div class="btns-group mb-20">
                        ...
                        <a href="#"
                            ...
                            <span class="flaticon-play"></span> See CHATIFINE in Action
                        </a>
                    </div>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Better Privacy Protected</h5>

                            <!-- Text -->
                            <p class="p-lg"> Employee privacy is more protected
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Internal Communication</h5>

                            <!-- Text -->
                            <p class="p-lg">Direct and fast internal communication
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-ico">
                            <div class="ico-60 shape-ico boxity-primary-color">
                                <img class="ico-bkg" src="{!!asset('images/boxity/ico-bkg.png')!!}" alt="ico-bkg">
                                <span class="flaticon-command"></span>
                            </div>
                        </div>
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Accessed simultaneously</h5>

                            <!-- Text -->
                            <p class="p-lg">Accessed simultaneously from various devices
                            </p>
