...
Boxity.')
@section('icon',
'https://res.cloudinary.com/boxity-id/image/upload/c_fit,w_64/v1656495463/asset/logo-products/fornax_logo_vm4een.png')
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-6 order-last order-md-2">
                <div class="hero-boxity-img pc-30 wow fadeInRight">
                    <img class="img-fluid" src="{!!asset('product/fornax/logo-mockup/desktop-phone.png')!!}"
                        alt="hero-image">
                </div>
            </div>
            ...
            <div class="col-md-7 col-lg-6 order-first order-md-2">
                <div class="hero-boxity-txt white-color wow fadeInLeft">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Manage your management issues optimally to keep your team running well</h2>
                    ...
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-ico">
                            <div class="ico-60 shape-ico boxity-primary-color">
                                ...
                                <span class="flaticon-analytics-3"></span>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Updated emails</h5>

                            <!-- Text -->
                            <p class="p-lg">Features automatic emails on any issue that the update
                            </p>
                ...
                <div class="col">
                    <div class="fbox-4 pc-25 mb-40 wow fadeInUp">
                        ...
                        <div class="fbox-txt">
                            ...
                            <!-- Title -->
                            <h5 class="h5-md">Priorities and Accountability</h5>

                            <!-- Text -->
                            <p class="p-lg"> Priorities and accountability set for fast and appropriate resolution
                            </p>
