...
const ContactUs = () => {
    ...
    return (
        <div id="contact" className="contact-area consulting-contact-area pt-100 pb-100">
			<div className="container">
				<div className="row">
					<div className="col-lg-4">
						<div className="contact-info">
							<h3>Contact us</h3>
							<p>Are you looking for an Consultant to advise at an event? We just need a little information.</p>
								
							<ul className="address">
								<li className="location">
									<span>Address</span>
									6890 Blvd, The Bronx, NY <br /> 1058 New York, USA
								</li>
								<li>
									<span>Email</span>
